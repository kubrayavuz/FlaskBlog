...
from FLASKBLOG import app, db, mail, Message
from FLASKBLOG.models import User,Post
from FLASKBLOG.forms import RegisterForm,LoginForm,PostForm,ContactForm
...
def contact():
    ...
    if request.method == 'POST':
        if form.validate_on_submit():
            msg = Message(form.name.data,sender='Flask Blog Contact Form', recipients=['seedacaglar@gmail.com'])
            msg.body="""
            From: %s
            <%s>
            %s
